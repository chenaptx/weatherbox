...
import * as sty from "./PlasmicCompletedButton7.module.css"; // plasmic-import: RaDOG038g-H-/css

export type PlasmicCompletedButton7__VariantMembers = {
  type: "primary" | "danger";
  border: "rounded" | "link";
  size: "small" | "large";
};

export type PlasmicCompletedButton7__VariantsArgs = {
  type?: SingleChoiceArg<"primary" | "danger">;
  border?: SingleChoiceArg<"rounded" | "link">;
  size?: SingleChoiceArg<"small" | "large">;
};

type VariantPropType = keyof PlasmicCompletedButton7__VariantsArgs;
export const PlasmicCompletedButton7__VariantProps = new Array<VariantPropType>(
  "type",
  "border",
  "size"
);

export type PlasmicCompletedButton7__ArgsType = {
  children?: React.ReactNode;
};

type ArgPropType = keyof PlasmicCompletedButton7__ArgsType;
export const PlasmicCompletedButton7__ArgProps = new Array<ArgPropType>(
  "children"
);

export type PlasmicCompletedButton7__OverridesType = {
  root?: p.Flex<"div">;
};

export interface DefaultCompletedButton7Props {
  children?: React.ReactNode;
  type?: SingleChoiceArg<"primary" | "danger">;
  border?: SingleChoiceArg<"rounded" | "link">;
  size?: SingleChoiceArg<"small" | "large">;
...
function PlasmicCompletedButton7__RenderFunc(props: {
  variants: PlasmicCompletedButton7__VariantsArgs;
  args: PlasmicCompletedButton7__ArgsType;
  overrides: PlasmicCompletedButton7__OverridesType;
  dataFetches?: PlasmicCompletedButton7__Fetches;
  forNode?: string;
}) {
...
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicCompletedButton7__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  // Explicitly specify variants, args, and overrides as objects
  {
    ...
    dataFetches?: PlasmicCompletedButton7__Fetches;
  } & Omit<PlasmicCompletedButton7__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicCompletedButton7__ArgsType, ReservedPropsType> &
