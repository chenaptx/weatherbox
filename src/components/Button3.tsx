...
import {
  PlasmicButton3,
  DefaultButton3Props
} from "./plasmic/play_plasmic/PlasmicButton3";
...
// Omit to hide them:
//
// interface Button3Props extends Omit<DefaultButton3Props, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
// You can also stop extending from DefaultButton3Props altogether and have
// total control over the props for your component.
interface Button3Props extends DefaultButton3Props {}

function Button3_(props: Button3Props, ref: HTMLElementRefOf<"div">) {
